/**
 * \file control_omnidrive_3_wheels.cpp
...
void ControlOmnidrive3Wheels::mixingFunc()
{
	...
	bool const do_move = !isStickInCenterPosition(fwd_bwd, DEADZONE_US) || !isStickInCenterPosition(left_right, DEADZONE_US);
...
bool ControlOmnidrive3Wheels::isStickInCenterPosition(uint16_t const pulse_duration_us, uint16_t const deadzone_us)
{
	...
	bool const is_stick_in_center_position = 
		(pulse_duration_us >= min_value_for_stick_in_center) 
		&&
